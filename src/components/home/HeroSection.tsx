      ...
      <div className="max-w-[1920px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 min-h-[500px]">
          ...
          <div className="md:col-span-2 relative bg-industrial-100 min-h-[400px] group overflow-hidden">
            ...
            <div className="absolute bottom-12 left-12 max-w-lg z-10">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
                Free Shipping on $300+ Only Online Orders
              </h1>
          ...
          <div className="md:col-span-1 bg-[#4a8ba8] relative overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1532153955177-f59af40d6472?q=80&w=1000')] bg-cover bg-center mix-blend-overlay opacity-30"></div>

            <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 p-8 z-10">
              <span className="block text-white/80 text-sm font-bold uppercase tracking-widest mb-2">
                Market Watch
              </span>
              <h2 className="text-3xl font-bold text-white mb-6 leading-tight">
                Q1 Industry Update:
                <span className="block opacity-90">
                  Packaging Materials & Economics
                </span>
              </h2>
          ...
          <div className="md:col-span-1 bg-[#e056fd] relative overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?q=80&w=1000')] bg-cover bg-center"></div>
