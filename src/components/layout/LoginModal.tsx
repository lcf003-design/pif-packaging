    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-md bg-white rounded-sm shadow-2xl overflow-y-auto max-h-[90vh] border border-industrial-200 z-[101]"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          <div className="p-8">
            ...
            <p className="text-industrial-500 mb-6">
              Log in to access your projects and orders.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-berlin-red text-white py-3 rounded-sm font-bold uppercase tracking-widest hover:bg-red-700 transition-colors shadow-lg shadow-berlin-red/20 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
