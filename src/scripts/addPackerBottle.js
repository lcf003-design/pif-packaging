  ...
  try {
    ...
    const payload = {
      fields: {
        ...
        name: { stringValue: "2 oz Dark Amber PET Plastic Wide Mouth Packer Bottles (Black Screw Top Cap) - 3369B01ABR" },
        ...
        imageUrl: { stringValue: "/images/catalog/3369b01abr_packer_amber.jpg" },
        description: { stringValue: "Premium 2 oz dark amber PET plastic wide mouth packer bottle with black continuous thread screw top closure. Ideal for light-sensitive pharmaceuticals, vitamins, supplements, and wellness products." },
